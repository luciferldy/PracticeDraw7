    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PropertyValuesHolder h1 = PropertyValuesHolder.ofFloat("scaleX", 0, 1);
                PropertyValuesHolder h2 = PropertyValuesHolder.ofFloat("scaleY", 0, 1);
                PropertyValuesHolder h3 = PropertyValuesHolder.ofFloat("alpha", 0, 1);

                ObjectAnimator.ofPropertyValuesHolder(view, h1, h2, h3).start();
            }
        });
    }
}
